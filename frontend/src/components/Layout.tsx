...
import { LayoutDashboard, Plus, Ticket, Clock, DollarSign, BarChart3, Users, LogOut, Activity } from 'lucide-react'
import { Button } from './ui/button'
import { Badge } from './ui/badge'
import { cn } from '../lib/utils'

export type TabType = 'dashboard' | 'risk' | 'generator' | 'redemptions' | 'history' | 'topups' | 'analytics' | 'users'
